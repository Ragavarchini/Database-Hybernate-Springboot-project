...
<style>
    ...
    .form-container input[type="text"], .form-container input[type="number"], .form-container input[type="date"], .form-container input[type="file"] {
        width: calc(100% - 20px);
        padding: 8px;
        margin-top: 5px;
...
<div class="form-container">
    ...
    <form action="DoctorController" enctype="multipart/form-data" method="post">
        <table>
            ...
            <tr>
                <td>Doctor Degree Certificate:</td>
                <td><input type="file" name="certificate" required></td>
            </tr>
            <tr>
                <td colspan="2"><b>Joining Information</b></td>
            </tr>
            <tr>
                <td>Joining Date:</td>
